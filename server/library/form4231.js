...
async function form4231(data) {
    try {
        ...
        const pdfPath = path.resolve(process.cwd(), './public/documents/form4231.pdf');
        ...
        const textTaxi = 'ค่ารถแท็กซี่หมายเลขทะเบียน ' +(data.taxi_plate || ' ' )+ ' ' +(data.province || ' ' )+ ' จาก สามย่าน มิตรทาวน์ถึง อาคารมหามกุฏ คณะวิทยาศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย';
